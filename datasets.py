...
def build_dataset(is_train, test_mode, args):
    if args.data_set == 'kinetics400':
        ...
        if is_train is True:
            mode = 'train'
            anno_path = os.path.join(args.video_anno_path, '/data/psh68380/repos/Video-CBM_/data/video_annotation/kinetics100/train.csv')
        elif test_mode is True:
            mode = 'test'
            anno_path = os.path.join(args.video_anno_path, 'kinetics400_test.csv') 
        else:  
            mode = 'validation'
            anno_path = os.path.join(args.video_anno_path, '/data/psh68380/repos/Video-CBM_/data/video_annotation/kinetics100/val.csv') 
